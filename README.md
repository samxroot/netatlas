...
## Features
- [x] Uses multi-threading to scan a /24 network in seconds instead of minutes.
- [x] Uses only Python standard libraries (`subprocess`, `concurrent.futures`, `ipaddress`).
- [x] Works on Windows, macOS, and Linux automatically.
